  ...
  return (
    <>
      ...
      <div
        ...
        className={`fixed bottom-0 left-0 right-0 z-[301] bg-[#faf7f2] rounded-t-2xl flex flex-col max-h-[85dvh] transition-transform duration-[380ms] ease-[cubic-bezier(0.32,0.72,0,1)] ${
